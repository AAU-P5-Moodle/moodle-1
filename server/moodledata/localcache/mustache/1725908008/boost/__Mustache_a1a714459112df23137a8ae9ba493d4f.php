...
class __Mustache_a1a714459112df23137a8ae9ba493d4f extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section8f73cd827ec067e43fb892e9a3c46cba($context, $indent, $value);
...
';
    ...
    private function section8f73cd827ec067e43fb892e9a3c46cba(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            <a data-toggle="collapse"
               ...
               class="btn btn-icon me-1 icons-collapse-expand stretched-link fheader {{#collapsed}}collapsed{{/collapsed}}"
            >
...
';
                ...
                $buffer .= 'container"
';
                $buffer .= $indent . '               class="btn btn-icon me-1 icons-collapse-expand stretched-link fheader ';
                $value = $context->find('collapsed');
