...
class __Mustache_fc800b442dd3541d92b542d8bb8611e6 extends Mustache_Template
{
...
';
        $value = $context->find('showemojipicker');
        $buffer .= $this->section1c8ce3c4e64480f5e4e0eb0081c64982($context, $indent, $value);
        $buffer .= $indent . '        <button
';
        $buffer .= $indent . '            class="btn btn-link btn-icon icon-size-3 ms-1 mt-auto"
';
        $buffer .= $indent . '            aria-label="';
        $value = $context->find('str');
...
';
    ...
    private function section1c8ce3c4e64480f5e4e0eb0081c64982(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '            <button
';
                $buffer .= $indent . '                class="btn btn-link btn-icon icon-size-3 ms-1"
';
                $buffer .= $indent . '                aria-label="';
                $value = $context->find('str');
