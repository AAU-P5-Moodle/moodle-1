...
class __Mustache_ae12a70ca94b15a15c4c2e651075c7fa extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block7b343a54c642ce1cfbae2dc81122cac5'),
            ));
...
';
    ...
    private function section1cd89d8a7d561c57c7e2902e6be4283e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section325dfee86f8fe2cebb95093e193bd6b5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section1cd89d8a7d561c57c7e2902e6be4283e($context, $indent, $value);
                $context->pop();
            }
        }
...
';
    ...
    public function block7b343a54c642ce1cfbae2dc81122cac5($context)
    {
        $indent = $buffer = '';
        $value = $context->findDot('element.frozen');
        if (empty($value)) {
...
';
        ...
        $value = $context->findDot('element.frozen');
        $buffer .= $this->section325dfee86f8fe2cebb95093e193bd6b5($context, $indent, $value);
