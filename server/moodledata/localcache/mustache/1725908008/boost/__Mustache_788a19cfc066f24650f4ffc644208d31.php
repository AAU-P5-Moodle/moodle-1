...
class __Mustache_788a19cfc066f24650f4ffc644208d31 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block34c08ed338e14647f3785fe97691b5d7'),
            ));
...
';
    ...
    public function block34c08ed338e14647f3785fe97691b5d7($context)
    {
        $indent = $buffer = '';
