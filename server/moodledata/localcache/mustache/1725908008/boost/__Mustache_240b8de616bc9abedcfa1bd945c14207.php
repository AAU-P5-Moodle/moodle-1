...
class __Mustache_240b8de616bc9abedcfa1bd945c14207 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template-inline')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block0cb3213c53fa987dc186798c46698614'),
            ));
...
';
    ...
    public function block0cb3213c53fa987dc186798c46698614($context)
    {
        $indent = $buffer = '';
