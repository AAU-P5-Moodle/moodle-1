...
class __Mustache_216d51cbf8b7ea84d9084b05f899a32a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block80d30f1f99ca2124c11087c57bb3577a'),
            ));
...
';
    ...
    public function block80d30f1f99ca2124c11087c57bb3577a($context)
    {
        $indent = $buffer = '';
        $value = $context->findDot('element.frozen');
        if (empty($value)) {
