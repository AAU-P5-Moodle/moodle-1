...
class __Mustache_7f22a0557830ec84d8de270f534b2ee1 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/drawer')) {
            $context->pushBlockContext(array(
                'drawercontent' => array($this, 'block797bf6a51cd0f8ed45b7a392134d8ac7'),
            ));
...
';
    ...
    public function block797bf6a51cd0f8ed45b7a392134d8ac7($context)
    {
        $indent = $buffer = '';
