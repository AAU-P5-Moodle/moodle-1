...
class __Mustache_8d05eb17766ff0001b76ee1a1542e8ce extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section1ba9453bdb7e4e6c8d8e0a1c7f418439($context, $indent, $value);
        $buffer .= '</ol>
';
        $buffer .= $indent . '</nav>
';
    ...
    private function section09c3ddffecde0107c9fdcb61dab774ec(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section1ba9453bdb7e4e6c8d8e0a1c7f418439(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section09c3ddffecde0107c9fdcb61dab774ec($context, $indent, $value);
                $value = $context->find('has_action');
                if (empty($value)) {
