...
class __Mustache_0cc7fdecd477cc53c6048acc12af5f92 extends Mustache_Template
{
...
';
        if ($parent = $this->mustache->loadPartial('theme_boost/drawer')) {
            $context->pushBlockContext(array(
                ...
                'drawercontent' => array($this, 'block404a1223711b4928f0cacccbdedd28b2'),
...
';
    ...
    private function section2a9e80ad7ea4e80f5a432fd3105c93dc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionA94e40a9120cb4a05e12812599fb901c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section2a9e80ad7ea4e80f5a432fd3105c93dc($context, $indent, $value);
                $value = $context->find('haschildren');
                if (empty($value)) {
...
';
    ...
    public function block404a1223711b4928f0cacccbdedd28b2($context)
    {
        $indent = $buffer = '';
        $buffer .= $indent . '        <div class="list-group">
';
        $value = $context->find('mobileprimarynav');
        $buffer .= $this->sectionA94e40a9120cb4a05e12812599fb901c($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
