...
class __Mustache_fcf08d7d3c4cc3250b5b26bf8fb2438a extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section610418ab0002079dbfb7bc0fdda52589($context, $indent, $value);
    ...
    private function section70a131dc0886ae2b026adfe850faf250(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section610418ab0002079dbfb7bc0fdda52589(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section70a131dc0886ae2b026adfe850faf250($context, $indent, $value);
                $buffer .= $indent . '        </fieldset>
';
                $buffer .= $indent . '    </div>
';
