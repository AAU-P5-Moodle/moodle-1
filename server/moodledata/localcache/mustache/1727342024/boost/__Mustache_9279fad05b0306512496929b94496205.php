...
class __Mustache_9279fad05b0306512496929b94496205 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionF02b6520cb7f4ef190772ef1b55d885f($context, $indent, $value);
        $value = $context->find('component');
        if (empty($value)) {
...
';
    ...
    private function sectionF02b6520cb7f4ef190772ef1b55d885f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
