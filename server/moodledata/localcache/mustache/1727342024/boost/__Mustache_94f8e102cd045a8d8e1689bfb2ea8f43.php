...
class __Mustache_94f8e102cd045a8d8e1689bfb2ea8f43 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block4d0bc5eec478728b86340e9f63430a8d'),
            ));
...
';
    ...
    public function block4d0bc5eec478728b86340e9f63430a8d($context)
    {
        $indent = $buffer = '';
