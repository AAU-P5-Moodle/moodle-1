...
class __Mustache_3842a38f3c3f470ae387ea2b615a650f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block1382ec6c2e8484100a4d1f1a267aeabc'),
            ));
...
';
    ...
    public function block1382ec6c2e8484100a4d1f1a267aeabc($context)
    {
        $indent = $buffer = '';
        $value = $context->findDot('element.frozen');
        if (empty($value)) {
