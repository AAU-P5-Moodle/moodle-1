...
class __Mustache_f3e2548387780a19ed19a364ce4f64fc extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block3dc08f16b32a1fb09719e979f7b649d3'),
            ));
...
';
    ...
    private function sectionFa6359212c11fa65b16aeeb4c5d211c7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    public function block3dc08f16b32a1fb09719e979f7b649d3($context)
    {
        $indent = $buffer = '';
...
';
        ...
        $buffer .= $this->sectionFa6359212c11fa65b16aeeb4c5d211c7($context, $indent, $value);
        $buffer .= $indent . '                ';
