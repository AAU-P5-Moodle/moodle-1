...
class __Mustache_d50d1157dcfc722926392292c95e2b92 extends Mustache_Template
{
...
';
        $value = $context->find('showemojipicker');
        $buffer .= $this->sectionC68d3e012e29d50cd9574195bdcb753f($context, $indent, $value);
...
';
    ...
    private function sectionC68d3e012e29d50cd9574195bdcb753f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
